...
train = spark.sql("SELECT Id, SalePrice as label, Condition1, CentralAir, Neighborhood, LotArea, OverallQual, OverallCond, YearBuilt, TotalBsmtSF, GrLivArea, MoSold, YrSold FROM raw_trainHP")
test = spark.sql("SELECT Id, Condition1, CentralAir, Neighborhood, LotArea, OverallQual, OverallCond, YearBuilt, TotalBsmtSF, GrLivArea, MoSold, YrSold FROM raw_testHP")
